...
/// <summary>
/// Extension methods cho Document — FilteredElementCollector, helper lọc element/type.
/// </summary>
public static class Extension
{
    ...
    public static ElementId getTextDefault(this Document doc)
    {
        ...
        if (defaultType != null)
        {
            TaskDialog.Show("Tên Kiểu Chữ Mặc Định", $"Kiểu chữ mặc định hiện tại là: {defaultType.Name}");
    ...
    /// <summary>
    /// Lọc element/type theo class, category, và điều kiện lambda.
    /// isType=true: FamilySymbol, FloorType, WallType... | isType=false: Floor, Level instance...
    /// </summary>
